...
higher-order functions and lazy evaluation. So functional program is messy or 
complicated, the programmer should attempt to modularize it and to generlize
the parts.
